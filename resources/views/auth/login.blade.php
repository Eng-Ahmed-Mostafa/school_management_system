<x-guest-layout>
    ...
    <div class="login-box mx-auto">
        <h2 class="fw-bold mb-1" style="color:#111827;">Account Login</h2>
        <p class="text-muted mb-4" style="font-size:.92rem;">Enter your credentials to access your
            administrative portal.</p>
        <form action="{{ route('login') }}" method="POST">
            @csrf
            <div class="mb-3">
                <x-input-label for="email" value="Username or Email"></x-input-label>
            ...
            <div class="mb-4">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="#" class="text-primary text-decoration-none" style="font-size:.88rem;">Forgot
                        password?</a>
                </div>
                <div class="input-group">
            ...
            <x-primary-button>Sign In to Dashboard →</x-primary-button>
        </form>
