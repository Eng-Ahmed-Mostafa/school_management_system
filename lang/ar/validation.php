...
return [
    ...
    */
    ...
    'accepted' => 'هذا الحقل يجب أن يكون مقبولاً.',
    'accepted_if' => 'هذا الحقل يجب أن يكون مقبولاً عندما يكون :other هو :value.',
    'active_url' => 'هذا الحقل يجب أن يكون عنوان URL صالح.',
    'after' => 'هذا الحقل يجب أن يكون تاريخًا بعد :date.',
    'after_or_equal' => 'هذا الحقل يجب أن يكون تاريخًا بعد أو يساوي :date.',
    'alpha' => 'هذا الحقل يجب أن يحتوي على أحرف فقط.',
    'alpha_dash' => 'هذا الحقل يجب أن يحتوي على أحرف وأرقام وشرطات وشرطات سفلية فقط.',
    'alpha_num' => 'هذا الحقل يجب أن يحتوي على أحرف وأرقام فقط.',
    'any_of' => 'هذا الحقل غير صالح.',
    'array' => 'هذا الحقل يجب أن يكون مصفوفة.',
    'ascii' => 'هذا الحقل يجب أن يحتوي على أحرف ورموز أحادية البايت فقط.',
    'before' => 'هذا الحقل يجب أن يكون تاريخًا قبل :date.',
    'before_or_equal' => 'هذا الحقل يجب أن يكون تاريخًا قبل أو يساوي :date.',
    'between' => [
        'array' => 'هذا الحقل يجب أن يحتوي على بين :min و :max عناصر.',
        'file' => 'هذا الحقل يجب أن يكون بين :min و :max كيلوبايت.',
        'numeric' => 'هذا الحقل يجب أن يكون بين :min و :max.',
        'string' => 'هذا الحقل يجب أن يكون بين :min و :max أحرف.',
    ],
    'boolean' => 'هذا الحقل يجب أن يكون صحيحًا أو خاطئًا.',
    'can' => 'هذا الحقل يحتوي على قيمة غير مصرح بها.',
    ...
    'password' => [
        ...
        'uncompromised' => 'حقل :attribute المعطى قد ظهر في تسريب بيانات. يرجى اختيار حقل :attribute مختلف.',
    ],
